...
export const ModalHeader: React.FC<Children> = ({ children }): JSX.Element => <div>{children}</div>;

export const ModalBody: React.FC<Children> = ({ children }): JSX.Element => <div>{children}</div>;

export const ModalFooter: React.FC<Children> = ({ children }): JSX.Element => <div>{children}</div>;
